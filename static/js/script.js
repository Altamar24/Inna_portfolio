...
document.querySelector('.js-ckarla-nav-toggle').addEventListener('click', function(e) {
    e.preventDefault();
    const sidebar = document.getElementById('ckarla-aside');
...
function handleDocumentClick(event) {
    ...
    const isMenuButton = event.target.closest('.js-ckarla-nav-toggle');
    
    if (sidebar.classList.contains('active') && !isClickInside && !isMenuButton) {
...
document.querySelector('.js-ckarla-nav-toggle').addEventListener('click', function() {
    if (document.getElementById('ckarla-aside').classList.contains('active')) {
